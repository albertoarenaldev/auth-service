...
public class SecurityConfig {
    ...
    /**
     * PasswordEncoder para hashear y verificar passwords de usuario.
     * Strength 12 = 2^12 = 4096 iteraciones de BCrypt (ver ADR-003:
     * BCrypt strength 12 — equilibrio entre seguridad y latencia).
     */
    @Bean
